...
<div id="shortcut-2013">
	<div class="w">
		...
		<ul class="fr lh">
			...
			<li class="fore4 ld menu" id="biz-com.jt.service" data-widget="dropdown" clstag="homepage|keycount|home2013|01e">
				<s></s>
				...
				<div class="dd">
					...
					<div><a href="http://www.jd.com/contact/com.jt.service.html" target="_blank">客服邮箱</a></div>
				</div>
			</li>
