...
function onlineService(t, e, i) {
    ...
    var v = "http://" + i + "/index.action?", b = {pid: a,price: g,stock: l,score: d,commentNum: p,imgUrl: h,wname: n,advertiseWord: o,seller: e,evaluationRate: u,recent: f,code: t,area: s($("#store-selector .text").text()),size: s($("#choose-version .dd .selected a").text()),services: s($("#summary-com.jt.service .dd").html())};
...
//                    $("#online-com.jt.service").show(), $("#j-im").attr("title", i + " \u8054\u7cfb\u5ba2\u670d"), $("#j-im").click(function() {
//                        onlineService(1, i, t.chatDomain)
//                    });
//                else if (2 == s) {
//                    $("#online-com.jt.service").show();
...
//                } else
//                    (3 == s || 9 == s) && ($("#online-com.jt.service").show().find("b").html("\u8054\u7cfb\u5ba2\u670d"), $("#j-im").addClass("d-offline").html("<b>\u7559\u8a00\u54a8\u8be2</b>").attr("title", i + " \u5ba2\u670d\u76ee\u524d\u4e0d\u5728\u7ebf\uff0c\u60a8\u53ef\u4ee5\u70b9\u51fb\u6b64\u5904\u7ed9\u5546\u5bb6\u7559\u8a00\uff0c\u5e76\u5728\u3010\u6211\u7684\u4eac\u4e1c->\u6d88\u606f\u7cbe\u7075\u3011\u4e2d\u67e5\u770b\u56de\u590d").click(function() {
...
//            }}) : 6728 == G.cat[0] && G.isJd ? $.ajax({url: "http://misc.360buyimg.com/product/js/2012/fittingsAuto.js?ver=20140424",dataType: "script",cache: !0}) : $.getJSONP("http://d.360buy.com/fittingInfo/get?skuId=" + t + "&callback=Recommend.cbRecoFittings"), void 0)
        ...
        i.show(), e.show(), "#th-com.jt.service" != t ? e.trigger("click") : a || e.trigger("click")
...
var Refresh = {init: function() {
        ...
        var e = $("#online-com.jt.service");
        t && (t.companyName || t.firstAddr || t.secAddr) && (e.after('<dl id="pop-company"><dt>\u516c\u53f8\u540d\u79f0\uff1a</dt><dd></dd></dl><dl id="pop-address"><dt>\u6240&nbsp;\u5728&nbsp;\u5730\uff1a</dt><dd></dd></dl>'), $("#pop-company dd").html(t.companyName), $("#pop-address dd").html(t.firstAddr + "&nbsp;" + t.secAddr), pageConfig.wideVersion && pageConfig.compatible && $("#online-com.jt.service dt").css("margin-bottom", 10))
        ...
        var e = t.parents(".com.jt.service-type").eq(0), i = e.find(".item");
...
//    G.isJd && "enabled" == pageConfig.btnBaiTiaoFq && t.after(e)
    ...
    pageConfig.product.havestock === void 0 ? (s = "", a = "http://cart.gift.jd.com/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = pageConfig.product.havestock ? "" : "disabled", pageConfig.product.havestock ? (s = "", a = "http://cart.gift.jd.com/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = "disabled", a = "#none")), 6980 == G.cat[2] && $('#product-detail [data-widget="tab-item"]').eq(3).hide(), $("#online-com.jt.service").find("b").html("\u8054\u7cfb\u5ba2\u670d"), $("#comments-list li").eq(4).html('<a href="javascript:;">\u6709\u6652\u5355\u7684\u8bc4\u4ef7<em>(0)</em></a>'), $("body").addClass("cat-1-" + G.cat[0] + " cat-2-" + G.cat[1] + " cat-3-" + G.cat[2] + " item-" + G.sku), G.onAttr("HYKHSP-2", function() {
        ...
        if ("disabled" == pageConfig.serviceYB)
            return !1;
        $("#choose-result").length > 0 ? $("#choose-result").before('<li id="choose-com.jt.service" class="hide"><div class="dt">\u4eac\u4e1c\u670d\u52a1\uff1a</div><div class="dd"></div></li>') : $("#choose-btns").length > 0 && $("#choose-btns").before('<li id="choose-com.jt.service" class="hide"><div class="dt">\u4eac\u4e1c\u670d\u52a1\uff1a</div><div class="dd"></div></li>');
        var t = $("#choose-btn-append a"), e = t.attr("href"), i = $("#choose-result .dd"), s = $("#choose-result .dd").html(), a = !1;
        JdService.init(G.sku, $("#choose-com.jt.service .dd"), function(n) {
