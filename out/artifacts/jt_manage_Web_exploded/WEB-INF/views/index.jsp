...
$(function(){
	$('#menu').tree({
		onClick: function(easyUITree){
			if($('#menu').tree("isLeaf",easyUITree.targets)){
				var tabs = $("#tabs");
				var tab = tabs.tabs("getTab",easyUITree.text);
				if(tab){
					tabs.tabs("select",easyUITree.text);
				}else{
					tabs.tabs('add',{
					    title:easyUITree.text,
					    href: easyUITree.attributes.url,
					    closable:true,
					    bodyCls:"content"
					});
				}
